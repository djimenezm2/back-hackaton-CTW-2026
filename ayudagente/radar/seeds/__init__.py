...
deployment depends on has no business sharing a `--clear` flag with a demo scenario.
"""

from ayudagente.radar.seeds import demo, pilot
from ayudagente.radar.seeds.base import Counts, Seed, Writer

SEEDS: dict[str, Seed] = {seed.name: seed for seed in (pilot.SEED, demo.SEED)}
