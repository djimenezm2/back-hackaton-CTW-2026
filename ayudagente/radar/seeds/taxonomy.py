...
def load(write: Writer) -> Counts:
    """
    Create the taxonomy, leaving any resource that already exists untouched.

    Args:
        write (Writer): Progress sink.

    Returns:
        Counts: How many resource types were created, zero on a second run.
    """
    created = 0
