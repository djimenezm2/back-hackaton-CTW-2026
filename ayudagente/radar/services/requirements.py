...
from ayudagente.radar.choices import LocationPrecision, RequirementStatus
...
def find_requirements(
    ...
    if only_unsaturated:
        qs = qs.exclude(Q(quantity__isnull=False) & Q(covered_quantity__gte=F("quantity"))).exclude(
